...
app.get('/dashboard', checkAuth, (req, res) => {
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <a href="/change-password" class="bg-white p-5 sm:p-6 rounded-2xl shadow-sm hover:shadow-md transition border border-[#d8ded5] flex items-center space-x-4 sm:space-x-5 group">
            <div class="bg-[#f0f4ee] text-[#586b55] p-3 sm:p-4 rounded-xl text-2xl sm:text-3xl group-hover:bg-[#586b55] group-hover:text-white transition">🔑</div>
            <div>
                <h3 class="font-bold text-base sm:text-lg text-[#363d34] group-hover:text-[#586b55] transition">Ganti Password</h3>
                <p class="text-xs sm:text-sm text-[#717d6e]">Ubah kata sandi akun Anda.</p>
            </div>
        </a>
    </div>`;
...
app.get('/change-password', checkAuth, (req, res) => {
    ...
    <div class="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-sm border border-[#d8ded5]">
        ...
        <form action="/change-password" method="POST" class="space-y-4">
            <div>
                <label class="block text-sm font-semibold text-[#475644]">Password Lama</label>
                <input type="password" name="oldPassword" required class="w-full px-4 py-2 border border-[#cbd5c8] rounded-xl outline-none focus:ring-2 focus:ring-[#586b55]">
            </div>
            <div>
                <label class="block text-sm font-semibold text-[#475644]">Password Baru</label>
                <input type="password" name="newPassword" required class="w-full px-4 py-2 border border-[#cbd5c8] rounded-xl outline-none focus:ring-2 focus:ring-[#586b55]">
            </div>
            <button type="submit" class="w-full bg-[#586b55] text-white py-3 rounded-xl font-bold hover:bg-[#475644]">Simpan Password Baru</button>
        </form>
